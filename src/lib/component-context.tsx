 ...
 */
export function useComponentContext<T = any>(): ComponentContext<any, T> {
...
/**
 * Hook to access component state
 */
export function useComponentState<T = any>(): [T | null, (state: T) => Promise<void>] {
  const { componentState, setComponentState } = useComponentContext();
...
export function useReadonly(): boolean {
  const { readonly } = useComponentContext();
  return readonly;
}
